...
const dict = {
  ...
  tcme: "Trusted Capable Model Environment: Analyses a model container in a sealed environment using established AI models (Trusted Capable Models) with given a set of instructions. " +
  ...
  lossofcontrol: "Loss-of-control of AI: Runaway activity, unintentional self-directed steering/goal-setting, and/or unforeseen critical behavior that cannot be undone. " +
    "It is not dependant on a 'will-to-power' or human-like consciousness. It can arise merely out of a misaligned sub-goal or perpetual control loop.",
  ...
  thestandard: "The Safety Standard: Voted-upon safety modules which embody the safety specs, red-lining and policies which apply to a registered model. Multiple standards are defined, applying conditionally on model architecture, tier and per voting over declared intent. " +
    "This flow allows constraint of a model's capabilities, differentiating on general and narrow models. e.g. Restricting a general-purpose model, or confining a narrow model to it's domain.",
